    ...
    let slider=[
        "https://assets.myntassets.com/w_980,c_limit,fl_progressive,dpr_2.0/assets/images/2022/11/8/93156ec1-1d4e-417c-8e17-ba56143d4a481667927056281-PreBuzz-Desktop-Banner.jpg",
        ...
        "https://assets.myntassets.com/w_980,c_limit,fl_progressive,dpr_2.0/assets/images/2022/8/1/70a3d1a4-f16a-45ca-9bb4-64dc2315352b1659297228544-Desktop-Banners_unisex-with-kids.jpg",
 ...
 let x=setInterval(()=>{
    ...
    x.setAttribute("src",slider[i]);
    document.querySelector("#slider").append(x);
    i=i+1;
    console.log(i);
 },2000);
